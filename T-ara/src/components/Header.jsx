  ...
  return (
    <header className="flex justify-between items-center px-8 py-4 bg-white shadow-md relative">
      ...
      <nav className="flex space-x-8 text-lg font-medium">
        <Link to="/shelterFinder" className="text-gray-700 hover:text-black transition">
          보호소 찾기
        </Link>
        <Link to="/live" className="text-gray-700 hover:text-black transition">
          라이브
        </Link>
        <Link to="/donation" className="text-gray-700 hover:text-black transition">
          후원하기
        </Link>
        <Link to="/community" className="text-gray-700 hover:text-black transition">
          소식
        </Link>
        <Link to="/reservation" className="text-gray-700 hover:text-black transition">
          산책예약
        </Link>
      </nav>
