...
const Individual = lazy(() =>
  import("./components/signup/Individual/Individual")
);
const Institution = lazy(() =>
  import("./components/signup/Institution/Institution")
);
...
const NoticeDetailPage = lazy(() =>
  import("./pages/community/NoticeDetailPage")
);

{
  /* 마이 페이지 영역 */
}
const MyHomePage = lazy(() => import("./pages/mypage/MyHomePage"));
const MyInformationPage = lazy(() =>
  import("./pages/mypage/MyInformationPage")
);
const WithdrawPage = lazy(() => import("./pages/mypage/WithdrawPage"));
const RegularSponPage = lazy(() => import("./pages/mypage/RegularSponPage"));
const TemporarySponPage = lazy(() =>
  import("./pages/mypage/TemporarySponPage")
);
...
const AnimalDonationSuccess = lazy(() =>
  import("./components/animal/AnimalDonationSuccess")
);
...
const StartLive = lazy(() =>
  import("./components/shelter/streaming/StartLive")
);
...
const PasswordCheckPage = lazy(() =>
  import("./pages/mypage/PasswordCheckPage")
);
const PageNotFound = lazy(() => import("./components/PageNotFound"));
const ShelterNoticeEdit = lazy(() =>
  import("./components/shelter/notice/ShelterNoticeEdit")
);
const NoticeDetail = lazy(() =>
  import("./components/shelter/notice/NoticeDetail")
);
const ReservationStatusPage = lazy(() =>
  import("./pages/ReservationStatusPage")
);
const WorkJournalDetailPage = lazy(() =>
  import("./pages/mypage/WorkJournalDetailPage")
);
  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <Routes>
        ...
        />
        <Route
          path="/mypage/workjournal/:diaryId"
          element={
            <ProtectedRoute>
              <WorkJournalDetailPage />
            </ProtectedRoute>
          }
        />
        ...
        />
        <Route
          path="/shelter/notice/edit/:noticeId"
          element={
            <ShelterProtectedRoute>
              <ShelterNoticeEdit />
            </ShelterProtectedRoute>
        ...
        <Route path="/animal/success" element={<AnimalDonationSuccess />} />
