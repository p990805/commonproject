            ...
            <div className="w-[90%] mx-auto bg-white p-5 flex flex-col justify-center">
                ...
                <div>
                    <div className="flex items-center justify-between border-x border-b border-gray-400">
                        ...
                        <button className="flex items-center justify-center p-2 border rounded border-gray-400 gap-2 mr-1">
                ...
                <div className="my-5">
                    <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                        ...
                        <div>
                            ...
                            <button className="border border-gray-400 rounded w-full py-2 cursor-pointer">
                                산책 예약하기
                            </button>
                        </div>
