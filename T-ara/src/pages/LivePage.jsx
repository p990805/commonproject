...
const LivePage=()=>{
    ...
    const [activeTab, setActiveTab] = useState(() => {
        return localStorage.getItem("activeTab") || "일상 라이브";
      });
    ...
    return(
        <div className="w-full bg-white">
            <div className="relative w-full">
                <img src="/assets/livebanner.png" alt="라이브배너"
                className="w-full object-cover brightness-90"
                />

                <div className="absolute bottom-[33%] right-[10%] text-white text-lg md:text-xl font-thin text-right">
                    <p className="text-left">후원자가 되시면 <br />
                    <span className="font-semibold">후원자 카드, 연차보고서 제공 및 <br />
                    기부금 세액공제 혜택</span>을 드립니다.
                    </p>
                </div>
            </div>
